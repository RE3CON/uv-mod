...
//            this.selectCustMenuStr.disabled = true;
    ...
    class Mod_RSSI extends FirmwareMod {
        constructor() {
            super("RSSI", "Тестовый мод. Добавляет вольтметр батареи на экран в строку состояния. Заменяет уровень сигнала цифровым значением RSSI и добавляет на выбор: s-метр со шкалой (урвни по 6дБ) или шкала RSSI.", "2250 или 1424");

            this.selectSbar = addRadioButton(this.modSpecificDiv, "S-метр, использует 2250 байт дополнительной памяти", "selectSbar", "selectRSSI");
            this.selectGraph = addRadioButton(this.modSpecificDiv, "Шкала RSSI, использует 1424 байта дополнеительной памяти, НЕ РАБОТАЕТ", "selectGraph", "selectRSSI");
