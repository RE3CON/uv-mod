  ...
  class Mod_TXRXOnAllBands extends FirmwareMod {
        ...
        apply(firmwareData) {
          ...
          //  const offset3 = 0xe0a8;  //diffs by RE3CON taken from Tunas1337 18-1300 Mod
            const offset2 = 0x150b;  //diffs by RE3CON taken from Tunas1337 18-1300 Mod
            const oldData1 = hexString("cf2a");  //TX lock //
         //   const oldData2 = hexString("80cba4"); // lower limit 50 lock
         //   const oldData3 = hexString(""); // upper limit 600 lock
            const oldData2 = hexString("00404b4c00008793037c");
            const newData1 = hexString("5de0"); //unlock TX 50-600 by R3CON //
          //  const newData2 = hexString("0040771b0080a4bf07a0"); //set lower freq to 18 by R3CON
          //  const newData3 = hexString("0040771b0080a4bf077c"); //set upper freq to 1300 by R3CON 
            const newData2 = hexString("0040771b0080a4bf077c"); // TX full range by R3CON
